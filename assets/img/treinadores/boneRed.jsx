...
function SvgBoneRed(props) {
  return (
    <Svg
      width={238}
      height={258}
      viewBox="60 20 258 258"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      {...props}
    >
      <Path fill="url(#pattern0)" d="M0.918335 0.415466H257.918335V257.415466H0.918335z" />
      <Defs>
        <Pattern id="pattern0" patternContentUnits="objectBoundingBox" width={1} height={1}>
          <Use xlinkHref="#image0_1262_35313" transform="scale(.0125)" />
        </Pattern>
        <Image
          id="image0_1262_35313"
          width={80}
          height={80}
